...
if($_POST)
{
	$virtualtrader->update_percent($_POST['percent'], $_POST['stock_code']);
}
?>
                   ...
                   <table class="table align-middle">
                     <thead class="table-light">  
                      <tr>
                        <td> <h5>Stocks</h5> </td>
                        <td></td>
                        <form action="?page=admin_stocks" method="post">
                        <td> 
                          
                            <select class="form-select" name="stock_code">
                              <option selected>Select stock to update</option>
                              <?php foreach($data as $table) {?>
                                <option value="<?php $table['code']; ?>"><?php echo $table['code']; ?></option>
                              <?php } ?>
                            </select>
                        </td>

                        <td><input class="form-control" type="text" placeholder="Difference Percentage" style="text-align:center;" name="percent"></td>
                        <td><button type="submit" class="btn btn-primary px-2 radius-30" value="submit">Update</button></td>
                        </form>
                      </tr>
                     </thead>
                    </table>
