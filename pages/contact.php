          ...
          <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <hr/>
                <form class="row g-3" action = "C:\xampp\htdocs\VinayIntern\pages\mail.php" method = "POST">
                  <div class="col-12">
                    <label class="form-label">Full Name</label>
                    <input type="text" class="form-control" placeholder = "Fore-Name Last-Name">
                  </div>
                  <div class="col-12">
                  ...
                  <div class="col-12">
                    ...
                    <input type="text" class="form-control" placeholder = "Help you need from us">
                  </div>
                  <div class="col-12">
                    <label class="form-label">Message</label>
                    <input type="text" class="form-control" placeholder = "Any message you want to share">
                  </div>
                  <div class="col-12">
                    <div class="d-grid">
                      <a class="btn btn-primary" href="mail.php" role="button">Submit</a>
                    </div>
                  </div>
                </form>
              </div>
