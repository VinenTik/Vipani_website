...
{ ?>
                    ...
                    <a href="?page=stockinfo&code=<?php echo $table['code']; ?>"><?php echo $table['name']; ?></a> </td>
                        ...
                        <?php echo $table['quantity']; ?>                     
                          ...
                          <?php 
                              if($table['diff'] > 0) 
                              { 
                                echo "<p style='color:green;'>" . $table['diff'] . "</p>";
                              } 
                              elseif($table['diff'] < 0) 
                              {
                                echo "<p style='color:red;'>" . $table['diff'] . "</p>";
                              
                              } 
                              else 
                              { 
                                echo "<p style='color:black;'>" . $table['diff'] . "</p>";
                              }  
                              ?>
                          ...
                          <td>
                          <?php  echo ($table['quantity']*$table['c_price'])-($table['quantity']*$table['p_price'])  ?>
                    ...
                    <?php } else { ?>
<p>You have not purchased any stock !!</p>
<?php } ?>
                   </div>
                 </div>
               </div>
