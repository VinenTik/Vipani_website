       ...
       <!--end top header-->
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <li class="menu-label">Dashboard</li>
            ...
            <li>
              <a href="?page=event">
                <div class="parent-icon"><i class="bi bi-calendar2-event-fill"></i>
                </div>
       ...
       <!--start content-->
         ...
         <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 row-cols-xxl-4">
          <div class="col">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="">
                        ...
                        <h4 class="mb-0 text-primary"><?php echo $session['username']; ?></h4>
                      </div>
               ...
               <?php if($data = $virtualtrader->portf($session['username']))
{
?>
               <div class="col">
                <div class="card radius-10">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="">
                        ...
                        <h4 class="mb-0 text-primary">₹ <?php echo $data; ?></h4>
                      </div>
                      <div class="ms-auto fs-2 text-primary">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="">
                        ...
                        <h4 class="mb-0 text-primary">₹ <?php echo $userbalance ; ?></h4>
                      </div>
                      <div class="ms-auto fs-2 text-primary">
               ...
               <?php if($data = $virtualtrader->getRank($session['username']))
{
?>
               <div class="col">
                <div class="card radius-10">
...
?>
 <?php if($data = $virtualtrader->GetUserStocksforHome($session['username']))
{
?>
...
if(isset($virtualtrader->successmsg)) { echo "<span class=\"successmsg\">"; foreach ($virtualtrader->successmsg as $vsmsg) { echo "$vsmsg<br/>"; } echo "</span><br/>"; }  
?>
<?php if($data = $virtualtrader->GetTop5Users())
{
?>
...
if(isset($virtualtrader->successmsg)) { echo "<span class=\"successmsg\">"; foreach ($virtualtrader->successmsg as $vsmsg) { echo "$vsmsg<br/>"; } echo "</span><br/>"; }  
?>
<?php if($data = $virtualtrader->GetStocksGreen())
{
?>
...
if(isset($virtualtrader->successmsg)) { echo "<span class=\"successmsg\">"; foreach ($virtualtrader->successmsg as $vsmsg) { echo "$vsmsg<br/>"; } echo "</span><br/>"; }  
?>
<?php if($data = $virtualtrader->GetStocksRed())
{
?>
                    <table class="table align-middle mb-0">
                      <thead class="table-light">
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                   ...
                   <?php
                    ...
                    if(isset($virtualtrader->successmsg)) { echo "<span class=\"successmsg\">"; foreach ($virtualtrader->successmsg as $vsmsg) { echo "$vsmsg<br/>"; } echo "</span><br/>"; }  
                  ?>
                  <?php if($data = $virtualtrader->GetStocksforNews()){?>
                  <?php foreach($data as $table){ ?>
                    <a style="color: black" href="?page=stockinfo&code=<?php echo $table['code'];?>">
                    <div class="card">
                    <div class="card-body">
                      <div>
                        <h5 class="card-title"><?php echo $table['code']; ?></h5>
                      </div>
                      <p class="card-text"><?php echo $table['news']; ?></p>
