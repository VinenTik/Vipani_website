			...
			if(is_countable($this->errormsg) == 0)
			{
				...
				else 
				{
					...
					else 
					{
						...
						$message_cont .= "We are happy to tell you that you have successfully registered a new account on Vipani- paper trading platform." . $auth_conf['site_name'] . "<br/>";
						$message_cont .= "Please click on the following link to activate your account.<br/>";
						$message_cont .= "<b><a href=\"" . $auth_conf['base_url'] . "?page=activate&username={$username}&key={$activekey}\">Activate my account</a></b></br>";
						$message_cont .= "Thank you !<br/>";
