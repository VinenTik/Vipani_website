...
$auth_conf['site_name'] = "Stock Market Simulation"; // Name of website to appear in emails
...
$auth_conf['security_duration'] = "+3 minutes"; // Amount of time to lock a user out of Auth Class afetr defined number of attempts.
